...
public class MenuTestData {
    ...
    public static Menu getNewMenu() {
        ...
        return new Menu(newRestaurant.getId(), newRestaurant.getName(), newRestaurant.getDishes(), false);
    }

    public static Menu testMenu() {
        RESTAURANT1.setDishes(Arrays.asList(DISH5, DISH6));
        return new Menu(RESTAURANT1.getId(), RESTAURANT1.getName(), RESTAURANT1.getDishes(), false);
    }

    public static List<Menu> allMenusOfDay() {
        RESTAURANT1.setDishes(Arrays.asList(DISH5, DISH6));
        RESTAURANT2.setDishes(Arrays.asList(DISH7, DISH8, DISH9, DISH10, DISH11));
        Menu MENU1 = new Menu(RESTAURANT1.getId(), RESTAURANT1.getName(), RESTAURANT1.getDishes(), false);
        Menu MENU2 = new Menu(RESTAURANT2.getId(), RESTAURANT2.getName(), RESTAURANT2.getDishes(), false);
